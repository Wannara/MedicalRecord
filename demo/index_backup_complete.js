...
app.get('/medicals/receipt',(req,res) =>{
    ...
    let receipt_detail_sql = `SELECT m.MRno, m.Date,m.HN, p.Address,m.PriceMed, mrd.drugID, d.drugName, d.Price, mrd.no_of_drug AS DrugAmount, mrd.no_of_drug*d.price as 'Total'
